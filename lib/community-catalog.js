...
const communityDesignSystems = [
  {
    ...
    name: 'Neon Command',
    description:
      'Dense operator UI for launch rooms, agent consoles, and command-heavy SaaS tools.',
...
- Keep contrast AA or better for status text.`,
  },
  {
    ...
    name: 'Editorial Lab',
    description:
      'Sharp editorial layouts for content-heavy launches, essays, research pages, and portfolios.',
    sourceRepo: COMMUNITY_REPO,
...
- Keep decorative motion subtle and optional.`,
  },
  {
    ...
    name: 'Product OS',
    description:
      'Clean product-building interface language for roadmaps, specs, handoffs, and async collaboration.',
    sourceRepo: COMMUNITY_REPO,
...
const communityTemplates = [
  {
    ...
    description:
      'A Next.js App Router starter direction for dashboards, agents, and SaaS control rooms.',
    sourceRepo: COMMUNITY_REPO,
    ...
    promptBias:
      'Prefer a dense dashboard shell with side navigation, route-ready sections, realistic demo data, loading states, empty states, and strong accessibility defaults.',
  },
  {
    id: 'community-astro-launch',
    name: 'Community Astro Launch Starter',
    description:
      'An Astro static starter direction for launch pages, editorial sites, and content-heavy product stories.',
    sourceRepo: COMMUNITY_REPO,
    baseTemplateId: 'astro',
    submitPath: 'scaffolds/astro-launch/template.json',
    recommendedUse:
      'static product launches, docs-adjacent sites, and high-performance editorial pages',
    promptBias:
      'Prefer an editorial Astro site with semantic content sections, real copy hierarchy, responsive image slots, SEO-ready structure, and accessible navigation.',
  },
];
