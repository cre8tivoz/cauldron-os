...
9. Click "Save Prototype & Blueprint" → saves `blueprint.md` + `.opencode/config.md` to ./projects/my-focus-timer/
10. Open that folder in your terminal and run `opencode` to continue building.
```
